...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.51ae785ace2ccb0a389da1cee5102adac90a80e371e3e790dde5a1c771c18b5e.js',function(){input.required=false;search();});}
